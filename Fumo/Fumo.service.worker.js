...
const CACHE_NAME = "Fumo-cache";
const OFFLINE_URL = "Fumo.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Fumo.html","Fumo.js","Fumo.wasm","Fumo.pck","Fumo.offline.html","Fumo.icon.png","Fumo.apple-touch-icon.png"];
